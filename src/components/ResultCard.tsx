...
const descriptionsPerJuiceId: {
  ...
  1: {
    ...
    resultSummary: (name: string) => (
      <div>
        <p>
          베리블루하우스익스트림은 선택하신 공약 중 절반 이상이 더불어민주당의
  ...
  3: {
    ...
    resultSummary: (name: string) => (
      <div>
        <p>
          자몽자이언트파이어볼은 선택하신 공약 중 절반 이상이 미래통합당의
          공약인 경우에 만들어지는 특별한 쥬스랍니다. 미래통합당이 추구하는
          방향과 정책이 {name}님이 옳다고 생각하시는 바와 비슷하다는 의미입니다.
  ...
  5: {
    ...
    resultSummary: (name: string) => (
      <div>
        <p>
          그레이트저스티스바나나는 이용자가 선택한 공약 중 절반 이상이 정의당의
  ...
  7: {
    ...
    resultSummary: (name: string) => (
      <div>
        <p>
          센트럴썬라이즈는 이용자가 선택한 공약 중 절반 이상이 국민의당의 공약인
  ...
  9: {
    ...
    resultSummary: (name: string) => (
      <div>
        <p>
          민초록레볼루셔너리밤은 이용자가 선택한 공약 중 절반 이상이 민생당의
  ...
  11: {
    ...
    resultSummary: (name: string) => (
      <div>
        <p>
          태극뽀빠이캐롯샤워는 이용자가 선택한 공약 중 절반 이상이 우리공화당의
  ...
  13: {
    ...
    resultSummary: (name: string) => (
      <div>
        <p>
          샤인레이버스더블샷은 이용자가 선택한 공약 중 절반 이상이 민중당의
  ...
  15: {
    ...
    resultSummary: (name: string) => (
      <div>
        <p>
          마이프렌들리파크는 이용자가 선택한 공약 중 절반 이상이 친박신당의
  ...
  17: {
    ...
    resultSummary: (name: string) => (
      <div>
        <p>
          프레시유니버스클렌즈는 이용자가 선택한 공약 중 절반 이상이 녹색당의
